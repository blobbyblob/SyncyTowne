...
function ImageButton:_UpdateButtonVisual()
	...
	local border = Color3.fromRGB(182, 182, 182)
	if self._Enabled then
		if self._Clicked then
			bg = Color3.fromRGB(219, 219, 219);
		elseif self._Hovered then
			if self._Selected then
				bg = Color3.fromRGB(229, 239, 254);
				border = bg;
			else
				bg = Color3.fromRGB(228, 238, 254);
			end
		else
			if self._Selected then
				bg = Color3.fromRGB(219, 219, 219);
